...
/**
 * You are given two s: initial and target. The goal of the game is to find a sequence of valid moves that will change initial into target. There are two types of valid moves:
...
public class ABBA {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new ABBA().canObtain("BBBBABABBBBBBA", "BBBBABABBABBBBBBABABBBBBBBBABAABBBAA")); //Possible
